# Code from http://plyr.had.co.nz/09-user/
...
# letter function returns the single letter at position n in the given string x
...
# vowels returns the number of vowels in the given string x
vowels <- function(x) {
  nchar(gsub("[^aeiou]", "", x))
}
